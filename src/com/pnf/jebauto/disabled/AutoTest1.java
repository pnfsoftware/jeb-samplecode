...
/**
 * Batch processing. Method 1: 1 engines context == 1 artifact
 * 
 * @author Nicolas Falliere
 * 
 */
public class AutoTest1 {
    static final ILogger logger = GlobalLog.getLogger(AutoTest1.class);
    static {
    ...
    public static void test(List<File> files) throws Exception {
        ...
        for(File file: files) {
            ...
            IRuntimeProject prj = engctx.loadProject("SampleProject");
            ...
            // done
            engctx.getExecutorService().shutdown();
